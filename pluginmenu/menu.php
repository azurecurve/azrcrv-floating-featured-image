 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_ffi')){
	function azrcrv_create_plugin_menu_ffi(){
		azrcrv_create_plugin_menu_table_ffi();
		azrcrv_populate_plugin_menu_table_ffi();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_ffi')){
	function azrcrv_populate_plugin_menu_table_ffi(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_ffi')){
	function azrcrv_create_plugin_menu_table_ffi(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';

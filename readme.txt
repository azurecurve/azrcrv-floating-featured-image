...
Download link:	https://github.com/azurecurve/azrcrv-floating-featured-image/releases/download/v1.1.4/azrcrv-floating-featured-image.zip
...
### [Version 1.1.4](https://github.com/azurecurve/azrcrv-floating-featured-image/releases/tag/v1.1.4)
 * Fix bug with setting of default options.
 * Fix bug with plugin menu.
 * Update plugin menu css.

### [Version 1.1.3](https://github.com/azurecurve/azrcrv-floating-featured-image/releases/tag/v1.1.3)
 * Rewrite default option creation function to resolve several bugs.
 * Fix bug in creation of sub menu.
